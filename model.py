...
class Model(torch.nn.Module):
    ...
    def __init__(self):
        ...
        setattr(self,'Conv_5', torch.nn.modules.conv.Conv2d(**{'in_channels':64,'out_channels':128,'kernel_size':(3, 3),'stride':(2, 2),'padding':(1, 1),'dilation':(1, 1),'groups':1,'padding_mode':'zeros'}))
        ...
        setattr(self,'Conv_7', torch.nn.modules.conv.Conv2d(**{'in_channels':64,'out_channels':128,'kernel_size':(1, 1),'stride':(2, 2),'padding':(0, 0),'dilation':(1, 1),'groups':1,'padding_mode':'zeros'}))
        ...
        setattr(self,'Conv_10', torch.nn.modules.conv.Conv2d(**{'in_channels':128,'out_channels':256,'kernel_size':(3, 3),'stride':(2, 2),'padding':(1, 1),'dilation':(1, 1),'groups':1,'padding_mode':'zeros'}))
        setattr(self,'Relu_9', torch.nn.modules.activation.ReLU(**{'inplace':False}))
        setattr(self,'Conv_11', torch.nn.modules.conv.Conv2d(**{'in_channels':256,'out_channels':256,'kernel_size':(3, 3),'stride':(1, 1),'padding':(1, 1),'dilation':(1, 1),'groups':1,'padding_mode':'zeros'}))
        setattr(self,'Conv_12', torch.nn.modules.conv.Conv2d(**{'in_channels':128,'out_channels':256,'kernel_size':(1, 1),'stride':(2, 2),'padding':(0, 0),'dilation':(1, 1),'groups':1,'padding_mode':'zeros'}))
        ...
        setattr(self,'Conv_15', torch.nn.modules.conv.Conv2d(**{'in_channels':256,'out_channels':512,'kernel_size':(3, 3),'stride':(2, 2),'padding':(1, 1),'dilation':(1, 1),'groups':1,'padding_mode':'zeros'}))
        setattr(self,'Relu_13', torch.nn.modules.activation.ReLU(**{'inplace':False}))
        setattr(self,'Conv_16', torch.nn.modules.conv.Conv2d(**{'in_channels':512,'out_channels':512,'kernel_size':(3, 3),'stride':(1, 1),'padding':(1, 1),'dilation':(1, 1),'groups':1,'padding_mode':'zeros'}))
        setattr(self,'Conv_17', torch.nn.modules.conv.Conv2d(**{'in_channels':256,'out_channels':512,'kernel_size':(1, 1),'stride':(2, 2),'padding':(0, 0),'dilation':(1, 1),'groups':1,'padding_mode':'zeros'}))
        ...
        setattr(self,'Conv_18', torch.nn.modules.conv.Conv2d(**{'in_channels':512,'out_channels':512,'kernel_size':(3, 3),'stride':(1, 1),'padding':(1, 1),'dilation':(1, 1),'groups':1,'padding_mode':'zeros'}))
        ...
        setattr(self,'GlobalAveragePool', onnx2torch.node_converters.global_average_pool.OnnxGlobalAveragePoolWithKnownInputShape(**{'input_shape':[0, 512, 10, 10]}))
    ...
    def forward(self, input_1):
        ...
        add_1 = self.Add_1(conv_4, relu_2);  conv_4 = relu_2 = None
        relu_4 = self.Relu_4(add_1);  add_1 = None
        conv_5 = self.Conv_5(relu_4)
        relu_5 = self.Relu_5(conv_5);  conv_5 = None
        conv_6 = self.Conv_6(relu_5);  relu_5 = None
        conv_7 = self.Conv_7(relu_4);  relu_4 = None
        add_2 = self.Add_2(conv_6, conv_7);  conv_6 = conv_7 = None
        ...
        conv_12 = self.Conv_12(relu_8);  relu_8 = None
        add_4 = self.Add_4(conv_11, conv_12);  conv_11 = conv_12 = None
        relu_10 = self.Relu_10(add_4);  add_4 = None
        conv_13 = self.Conv_13(relu_10)
        relu_11 = self.Relu_11(conv_13);  conv_13 = None
        conv_14 = self.Conv_14(relu_11);  relu_11 = None
        add_5 = self.Add_5(conv_14, relu_10);  conv_14 = relu_10 = None
        ...
        conv_17 = self.Conv_17(relu_12);  relu_12 = None
        add_6 = self.Add_6(conv_16, conv_17);  conv_16 = conv_17 = None
        relu_14 = self.Relu_14(add_6);  add_6 = None
        conv_18 = self.Conv_18(relu_14)
        relu_15 = self.Relu_15(conv_18);  conv_18 = None
        conv_19 = self.Conv_19(relu_15);  relu_15 = None
        add_7 = self.Add_7(conv_19, relu_14);  conv_19 = relu_14 = None
